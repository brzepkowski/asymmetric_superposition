...
# fitted on one sample and scored on another. Left: the MSE averaged over the four features, for several
# resolutions; middle: the same sweep split into the MSE of each feature, at the finest resolution; right:
...
fig, axes = plt.subplots(1, 3, figsize=(16, 3.8), layout="constrained", sharey=True)
ax = axes[0]
