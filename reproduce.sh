...
for f in posterior_sym asym_compare asym_sweep opening_sweep ratio_sweep class_compare gallery search_geometry optimal_geometry opened_cut class_check long_run; do
  echo "== figures/$f.py"
  $PY -m figures.$f
done
